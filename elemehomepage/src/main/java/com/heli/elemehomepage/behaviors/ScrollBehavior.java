package com.heli.elemehomepage.behaviors;
...
import com.heli.elemehomepage.R;
...
//        return super.onLayoutChild(parent, child, layoutDirection);
    ...
    public boolean onDependentViewChanged(
        CoordinatorLayout parent, RecyclerView child, View dependency) {
    ...
    public boolean onStartNestedScroll(
        CoordinatorLayout coordinatorLayout, RecyclerView child, View directTargetChild, View target, int nestedScrollAxes) {
    ...
    public void onNestedPreScroll(
        CoordinatorLayout coordinatorLayout, RecyclerView child, View target, int dx, int dy, int[] consumed) {
...
//        super.onNestedScroll(coordinatorLayout, child, target, dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed);
    ...
    public boolean onNestedPreFling(
        CoordinatorLayout coordinatorLayout, RecyclerView child, View target, float velocityX, float velocityY) {
//        return super.onNestedPreFling(coordinatorLayout, child, target, velocityX, velocityY);
    ...
    public void onStopNestedScroll(
        CoordinatorLayout coordinatorLayout, RecyclerView child, View target) {
    ...
    private boolean onDragEnd( float velocityY) {
        ...
        if (Math.abs(velocityY)<800) {//速度小 则以当前位置判断
            if (Math.abs(currentTranslation) > maxCollapsing * 0.5f) {
                scroller.startScroll(0, currentTranslation, 0, -maxCollapsing-currentTranslation,(int) (1000000 / Math
                    .abs(800)));
            } else {
                scroller.startScroll(0, currentTranslation, 0, -0-currentTranslation,(int) (1000000 / Math
                    .abs(800)));
            }
        }else {
            if (velocityY>0) {
                scroller.startScroll(0, currentTranslation, 0, -maxCollapsing-currentTranslation,(int) (1000000 / Math
                    .abs(velocityY)));
            }else  scroller.startScroll(0, currentTranslation, 0, -0-currentTranslation,(int) (1000000 / Math
                .abs(velocityY)));
        }
